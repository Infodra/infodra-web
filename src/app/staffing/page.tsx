...
export const metadata: Metadata = {
  title: "Staffing Solutions | Engineering & Technology Staffing | Infodra Technologies",
  description:
  ...
  openGraph: {
    ...
    url: "https://infodra.com/staffing",
    type: "website",
  },
};
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-lg md:text-xl mb-10 text-gray-600 max-w-2xl leading-relaxed">
              ...
              below and explore our dedicated Engineering or Technology staffing
              capabilities.
            </p>
      ...
      <section id="choose" className="py-20 md:py-28 bg-white border-t border-gray-100">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            {/* Manufacturing Technical Staffing Card */}
            <div className="relative group p-10 rounded-2xl border-2 border-gray-200 bg-gradient-to-br from-amber-50/40 to-white hover:border-amber-400 hover:shadow-xl transition-all flex flex-col">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-3">
                Manufacturing Technical Staffing
              </h3>
              <p className="text-gray-600 mb-6 leading-relaxed">
