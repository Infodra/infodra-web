        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <section className="mb-16 bg-blue-50 border-l-4 border-blue-600 p-8 rounded-lg">
            ...
            <p className="text-gray-700 mb-4 leading-relaxed">
              <strong>Data Deletion Rights:</strong> Applicants may request deletion of their data by contacting us at <a href="mailto:info@infodra.in" className="text-blue-600 hover:underline">info@infodra.in</a> or via WhatsApp at 81481 46785.
            </p>
          </section>
          ...
          <section className="mb-16 bg-gray-50 border border-gray-200 p-8 rounded-lg">
            ...
            <div className="bg-white p-6 rounded-lg border border-gray-200">
              ...
              <p className="text-gray-700 mb-2">
                <strong>Email:</strong>{" "}
                <a href="mailto:info@infodra.in" className="text-blue-600 hover:underline">
                  info@infodra.in
                </a>
              </p>
